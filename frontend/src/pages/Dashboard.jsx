...
export default function Dashboard({ user }) {
  ...
  const prevMonth = () =>
    setMonth((prev) =>
      prev.m === 1 ? { m: 12, y: prev.y - 1 } : { m: prev.m - 1, y: prev.y },
    );
  const nextMonth = () =>
    setMonth((prev) =>
      prev.m === 12 ? { m: 1, y: prev.y + 1 } : { m: prev.m + 1, y: prev.y },
    );
      ...
      <div className="main-area">
        <header className="topbar">
          ...
          >
            ...
            >
              <div
                className={`switch-track ${theme === "light" ? "active" : ""}`}
                onClick={toggleTheme}
              ...
              <div
                className={`switch-track ${language === "en" ? "active" : ""}`}
        ...
        <main className="content">
          {chatError && (
            <div className="stat-card" style={{ borderLeft: '4px solid var(--coral)', marginBottom: '2rem', color: 'var(--coral)', fontWeight: 700 }}>
              ⚠️ Error: {chatError}
            </div>
          )}
          ...
          >
            ...
            >
              ...
              <div
                className="stat-card"
                style={{ borderLeft: "4px solid var(--indigo)" }}
              >
                <h4
                  style={{
                    marginBottom: "1rem",
                ...
                >
                  💡 {language === "vi" ? "Mẹo chi tiêu" : "Spending Tip"}
                </h4>
                <p
                  style={{
                    fontSize: "13px",
            ...
            >
              <TransactionCharts transactions={expenses} />
        ...
        <ChatBot onTransactionCreated={loadData} />
      </div>
    </div>
  );
}
